                    ...
                    <div class="lgx-tab">
                        ...
                        <ul class="nav nav-pills lgx-nav">
                            ...
                            @if (Auth::user()->hasRole('organiser'))
                                <li data-toggle="pill" :class="{ 'active': currentRouteName == 'stripe' }">
                                    <router-link :to="{ name: 'stripe' }">
                                        <h3>
                            ...
                            @if (!Auth::user()->hasRole('customer') || Auth::user()->hasRole('organiser'))
                                <li data-toggle="pill" :class="{ 'active': currentRouteName == 'seller-info' }">
                                    <router-link :to="{ name: 'seller-info' }">
                                        <h3>
                            ...
                            @if (!Auth::user()->hasRole('customer'))
                                <li data-toggle="pill" :class="{ 'active': currentRouteName == 'mail-chimp' }">
                                    <router-link :to="{ name: 'mail-chimp' }">
                                        <h3>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" name="organisation" type="text"
                                                    placeholder="@lang('eventmie-pro::em.brand_identity')" value="{{ $user->organisation }}" required>
